...
ASSISTANT_NAME = "asst_Fr1RaxPc0CiTig1H0efdgvGY"
...
def get_assistant():
    ...
    existing_assistants = st.session_state.client.beta.assistants.list()

    for existing_assistant in existing_assistants:
        if existing_assistant.id == ASSISTANT_NAME:
            return existing_assistant

    # Create the assistant if it does not exist
    return st.session_state.client.beta.assistants.create(
        name=ASSISTANT_NAME,
